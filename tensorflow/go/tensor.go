...
// https://github.com/Dilshat/tensorflow/issues/6003.
...
func bug(format string, args ...interface{}) error {
	return fmt.Errorf("BUG: Please report at https://github.com/Dilshat/tensorflow/issues with the note: Go TensorFlow %v: %v", Version(), fmt.Sprintf(format, args...))
}
...
func isTensorSerializable(dataType DataType) error {
	...
	case Float, Double, Int32, Uint8, Int16, Int8, Complex, Int64, Bool, Quint8, Qint32, Bfloat16, Qint16, Quint16, Uint16, Complex128, Half:
		return nil
	default:
		return fmt.Errorf("serialization of tensors with the DataType %d is not yet supported, see https://github.com/Dilshat/tensorflow/issues/6003", dataType)
	}
}
